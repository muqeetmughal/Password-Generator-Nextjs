    ...
    <div className="w-full h-full sm:max-w-screen-sm sm:mx-auto">
        ...
        <div className="card my-1 shadow-xl">
          <div className="card-body">
            ...
            <p>At Free Password Generator, accessible from freepasswordgenerator.app, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Free Password Generator and how we use it.</p>
            <h3>Log Files</h3>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Free Password Generator. This policy is not applicable to any information collected offline or via channels other than this website.</p>
            <h3>Consent</h3>
